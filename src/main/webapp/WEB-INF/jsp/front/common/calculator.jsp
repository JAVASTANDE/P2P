...
<link rel="stylesheet" href="${PATH }/common/css/bootstrap.min.css">
<link rel="stylesheet" href="${PATH }/front/common/css/layer.css" />

<script type="text/javascript" src="${PATH }/common/js/jquery.min.js"></script>
<script type="text/javascript" src="${PATH }/front/common/js/layer.js"></script>
		...
		<div class="modal-content">
			<div class="modal-header bb-no">
				<div style="text-align:center;font-size: xx-large;">
					<p>
						<a href="${PATH }/index.htm"><strong>返回首页</strong>
						</a>
					</p>
				</div>
			</div>
						...
						<div class="panel-heading">
							<h3 class="panel-title calc-title rel">
								...
								<div class="cal-tabs">
									...
									<!-- <div class="calc-tab  jCalcTab">债权转让</div> -->
								</div>
							</h3>
						</div>
							...
							<div class="calc-bd-tabs jCalcBdTabs">
								<div class="cal-bd-tab jCalBdTab">
									...
									<div class="row mt-15">
										...
										<div
											class="col-md-6 col-sm-6 mt-md-10  mt-sm-10  mt-xs-10 col-xs-12">
											...
											<div class="col-xs-8">
												<div class="input-group">
													...
													<div class="input-group-addon calc-addon">
														<input type="radio" name="nyy" id="yue" value="1" checked="" />月 <input type="radio" name="nyy" id="tian" value="2" />天
													</div>
												</div>
											</div>
									...
									<div class="row mt-15">
										<div class="col-md-12 tc"
											...
											<div class="col-xs-6 tc" style="text-align: center;">
												<input type="button" value="重置数据" class="reset" id="btn-reset" /> <span id="expect-profit"></span>
											</div>
										</div>
								...
								<!-- <div class="cal-bd-tab hidden jCalBdTab"> </div> -->
							</div>
							<!--投资理财，债权转让tab框END-->
							<!-- <br>
							<div class="calc-tps mt-20 text-center">
								<strong>计算明细</strong>
							</div> -->
							<br/>
							<div class="table-responsive"></div>
							<div id="bxmx" style="width:570px;height:225px;overflow:auto;">
	...
	<script>
		...
		$("#btn-profit").on("click",function() {
							...
							if (parseFloat(nhlv) > 50) {
								layer.tips('请输入正确的年利率，年利率不能超过50%！', $('#nhlv'),
										{
											tips : [ 3, '#53a0e3' ],
											time : 2000
										});
							...
							if (parseFloat(jkje) > 2000000) {
								layer.tips('投标金额不能超过2000000', $('#jkje'), {
									tips : [ 3, '#53a0e3' ],
									time : 2000
								});
								$("#jkje").val('').focus();
							...
							case 1:
								...
								for ( var i = 1; i < jkqx; i++) {
									var objb = $("<tr style='height: 40px;'>"
											+ " <td align='center' >" + i + "</td>"
											+ " <td align='center' >" + sumfinalEve + "元</td>"
											+ " <td align='center' >0元</td>"
											+ " <td align='center' >" + sumfinalEve + "元</td>"
											+ " <td align='center' >" + (parseFloat(jkje) * 1 + sumfinal * 1 - sumfinalEve * i).toFixed(2) + "元</td></tr>");
									$("#repayplan").append(objb);
								}
								var objb = " <tr style='height:40px'>"
										+ " <td align='center'>" + jkqx + "</td>"
										+ " <td align='center'>" + (parseFloat(jkje) * 1 + sumfinalEve * 1).toFixed(2) + "元</td>"
										+ " <td align='center'>" + parseFloat(jkje).toFixed(2) + "元</td>" 
										+ " <td align='center'>" + sumfinalEve + "元</td>"
